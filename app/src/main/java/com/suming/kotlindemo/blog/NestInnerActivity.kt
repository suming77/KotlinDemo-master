...
class NestInnerActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /**
         *1.我们不再通过显式定义一个父实现的子类来创建对象，而是直接通过父实现来创建一个没有名字的对象，
    ...
    class Outer {
        ...
        /**
         * 2.类 Nested 嵌套在类 Outer 内部，称为嵌套类；类 Outer 相对于类 Nested 来说是外部类。
        ...
        /**
         * 3.在 Kotlin 中，只有被 `inner` 标记的嵌套类才叫内部类，其他在类内部写的类统称为嵌套类。
